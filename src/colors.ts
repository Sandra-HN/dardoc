...
export const colorsOutline = {
  ...
  info: [colorsText.info, 'border-lightPrimary-900'].join(' '),
};
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      info: 'ring-lightPrimary-500 dark:ring-darkPrimary-500',
    },
    active: {
      white: 'bg-gray-100',
      ...
      info: 'bg-lightPrimary-900 dark:bg-darkPrimary-900',
    },
    bg: {
      white: 'bg-white text-black',
      ...
      info: 'bg-lightPrimary-900 dark:bg-darkPrimary-900 text-white',
    },
    bgHover: {
      ...
      info: 'hover:bg-lightPrimary-500 hover:border-lightPrimary-500 hover:dark:bg-darkPrimary-500 hover:dark:border-darkPrimary-500',
    },
    borders: {
      white: 'border-white',
      ...
      info: 'border-lightPrimary-900 dark:border-darkPrimary-900',
    },
    text: {
      ...
      info: 'text-darkPrimary-900 dark:text-lightPrimary-900',
    },
    outlineHover: {
      contrast:
      ...
      info: 'hover:bg-lightPrimary-900 hover:text-white hover:dark:text-white hover:dark:border-lightPrimary',
    },
  };
